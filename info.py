...
PICS = (environ.get('PICS', 'https://i.ibb.co/jZThsMDt/ea2e60ca46fc.jpg')).split()  # Sample pic
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002205583414'))  # Notification of those who verify will be sent to your channel
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002452396602').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002147724172').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sufiya:ayesha@cluster0.owapcde.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Kalki:Tabhi@cluster0.ssrpwsf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/xmovieshub56')  # How to open tutorial link for verification
